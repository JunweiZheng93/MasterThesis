hparam = {
    ...
    'model_path': '/home/ies/zhen/MasterThesis/results/20210729015701/process_2/checkpoint.h5',
    ...
    'decay_step_size': 100,
    'decoded_part_binary_threshold': 0.1,  # threshold for the binary decoded part
